...
if [ -z "$GITHUB_TOKEN" ]; then
    print_error "GITHUB_TOKEN não definido"
    echo ""
    echo "Para repositórios privados, você precisa de um Personal Access Token do GitHub."
    echo ""
    ...
    echo ""
    echo "2. Execute o script com o token:"
    echo "   GITHUB_TOKEN=seu_token_aqui ./install-private.sh"
    echo ""
    echo "Ou defina permanentemente:"
...
get_latest_version() {
    ...
    if [ -z "$VERSION" ]; then
        ...
        print_warning "Verifique se o token tem permissão de acesso ao repositório"
        exit 1
    fi
...
download_deck() {
    ...
    if ! curl -fsSL -H "Authorization: token $GITHUB_TOKEN" \
         ...
         "$DOWNLOAD_URL" -o deck; then
        print_error "Falha ao baixar $DOWNLOAD_URL"
        print_warning "Verifique se o release existe e o token tem permissão"
        rm -rf "$TMP_DIR"
        exit 1
    fi
...
main() {
    echo ""
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${BLUE}  Instalador do Deck (Repositório Privado)${NC}"
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
